...
namespace ProjectMain.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        public SalesController(curdReactDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Sales>> DeleteSales(int id)
        {
            ...
            var sales = await _context.Sales.Include(c => c.Customer).Include(p => p.Product).Include(s => s.Store).FirstOrDefaultAsync(s => s.Id == id);
            if (sales == null)
            {
                return NotFound();
            }
